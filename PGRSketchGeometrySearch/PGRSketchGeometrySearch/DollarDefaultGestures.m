...
+ (NSMutableArray *)pointClouds {
    ...
    pointClouds[0] = MakePointCloud(@"circle", @[
                                                  MakePoint(98.08,19.51,1),
                                                  MakePoint(92.39,38.27,1),
                                                  MakePoint(83.15,55.56,1),
                                                  MakePoint(70.71,70.71,1),
                                                  MakePoint(55.56,83.15,1),
                                                  MakePoint(38.27,92.39,1),
                                                  MakePoint(19.51,98.08,1),
                                                  MakePoint(0.00,100.00,1),
                                                  MakePoint(-19.51,98.08,1),
                                                  MakePoint(-38.27,92.39,1),
                                                  MakePoint(-55.56,83.15,1),
                                                  MakePoint(-70.71,70.71,1),
    ...
    pointClouds[2] = MakePointCloud(@"rectangle", @[
                                                    MakePoint(0, 347, 1),
                                                    MakePoint(347, 347, 1),
    ...
    pointClouds[6] = MakePointCloud(@"rectangle", @[
                                                 MakePoint(0, 170, 1),
                                                 MakePoint(170, 0, 1),
    ...
    pointClouds[7] = MakePointCloud(@"rectangle", @[
                                                    MakePoint(0, 170, 1),
                                                    MakePoint(347, 170, 1),
    ...
    pointClouds[8] = MakePointCloud(@"rectangle", @[
                                                    MakePoint(0, 347, 1),
                                                    MakePoint(170, 347, 1),
    ...
    pointClouds[9] = MakePointCloud(@"triangle", @[
                                                    MakePoint(0, 400, 1),
                                                    MakePoint(300, 0, 1),
